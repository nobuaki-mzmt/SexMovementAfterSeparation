...
for(j in 1:length(f.namesplace_solo)){
  ...
  mean_speed <- cbind(obj,  tapply(na.omit(d$speed[!stop]), minutes[1:L][!is.na(d$speed)&!stop], mean))
...
# [1]  0.0000  0.0000  0.0003  0.1021  0.0431  0.0075  0.0091  0.1316  0.0077  1.1266  0.4453
#[12]  0.0466  4.0079  4.0731  0.9236  0.3470  0.2097  0.0127  0.2633  0.3282  0.9862  1.9386
#[23] 15.0965  0.9685  8.2194  0.4269 18.7147 16.4325 10.5999 28.6504
...
round(as.numeric(P)*70,4)
##[1] 27.0603 26.2577 38.9785 29.0273  7.6178  4.6902 49.0886 47.5709 29.4519 10.3789 24.2653
#[12]  5.6211  9.2179  0.5084  2.8432 15.5643  0.9551  4.9389 19.7280  4.3300  1.2400  8.0182
#[23]  0.2221 28.0692 14.7362 15.9809  9.4689  5.6342  2.0566  8.5724
...
round(as.numeric(P)*70,4)
##[1] 1.8715 33.2354 52.2652 23.1597 36.5812  7.8967 24.5468 49.9258  2.0619 36.3265
...
res_tandem_se <- tapply(res_tandem$mean_speed, res_tandem[,c(5,2)], se)[1:10,]
...
# [1] 0.0000 0.0000 0.0000 0.0000 0.0001 0.0004 0.0000 0.0006 0.0001 0.0002 0.0095 0.0001 0.0008
#[14] 0.0046 0.0146 0.0122 0.1833 0.0092 0.0010 0.4145 0.0224 0.3238 0.4383 0.2089 0.1190 0.0073
#[27] 2.3123 3.3412 0.2170 0.6415
...
round(as.numeric(P)*30,4)
##[1] 11.5973 11.2533 16.7051 12.4403  1.5462  0.7831 21.0380 13.9776  7.6211  4.4481  5.9777
#[12]  1.0680  3.9505  0.1128  0.6409  6.6704  0.1275  0.7895  8.4549  0.9684  0.2078  3.4364
#[23]  0.0952  6.9893  6.3155  8.2354  2.3432  2.4147  0.3073  1.6321
...
res_tandem_se <- tapply(res_tandem$mean_angle, res_tandem[,c(5,2)], se)[1:10,]
...
#       treat
#sex    before     after
#  1  0.5858232 0.7239434
#  0 0.5934956 1.3041740
