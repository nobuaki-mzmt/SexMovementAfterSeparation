...
data.place <- "E:\\Dropbox\\research\\with_dropbox\\papers and projects\\2017\\Sex movement after separation\\Simulations\\data\\Rs_EnSim_FMBA_rep1000000_SepSearch_SepDis16.csv"
d <- read.csv(data.place, header=T)
name <- d[,1:2]
names <- paste(name[,1],name[,2], sep=" and ")
time <- seq(0.2, 60, 0.2)
rep <- 1000000
plot_data <- t(d[,3:(60*5+2)])
par(pin=c(5,4), mfrow=c(1,1))
matplot(time, plot_data[,c(1,4:6)]/rep, type="l", las=1,
        xlab="time (sec)", ylab="Encounter rate")
legend(40,0.15, names[c(1,4:6)], col=1:4, lty=1:4)

matplot(time, plot_data[,c(1,4:6)]/rep, type="l", las=1, log="x",
        xlab="time (sec)", ylab="Encounter rate")
legend(40,0.15, names[c(1,4:6)], col=1:4, lty=1:4)

## Random search 
data.place <- "E:\\Dropbox\\research\\with_dropbox\\papers and projects\\2017\\Sex movement after separation\\Simulations\\data\\Rs_EnSim_FMBA_rep1000000_RanSearch_L223.csv"
d <- read.csv(data.place, header=T)
name <- d[,1:2]
names <- paste(name[,1],name[,2], sep=" and ")
time <- seq(0.2, 60, 0.2)
...
matplot(time, plot_data[,c(1,4)]/rep, type="l", las=1,
        xlab="time (sec)", ylab="Encounter rate")
legend(40,0.1, names[c(1,4)], col=1:4, lty=1:4)
...
## Sep search condition
data.place <- "E:\\Dropbox\\research\\with_dropbox\\papers and projects\\2017\\Sex movement after separation\\Simulations\\data\\EnSim_Cf_FMBA_rep1000000_SepSearch_SepDis16.csv"
d <- read.csv(data.place, header=T)
name <- d[,1:2]
names <- paste(name[,1],name[,2], sep=" and ")
time <- seq(0.2, 60, 0.2)
...
matplot(time, plot_data[,c(1,4:6)]/rep, type="l", las=1,
        xlab="time (sec)", ylab="Encounter rate")
legend(20,0.15, names[c(1,4:6)], col=1:4, lty=1:4)


## Random search 
data.place <- "E:\\Dropbox\\research\\with_dropbox\\papers and projects\\2017\\Sex movement after separation\\Simulations\\data\\EnSim_Cf_FMBA_rep1000000_RanSearch_L223.csv"
d <- read.csv(data.place, header=T)
name <- d[,1:2]
names <- paste(name[,1],name[,2], sep=" and ")
time <- seq(0.2, 60, 0.2)
...
matplot(time, plot_data[,c(1,4)]/rep, type="l", las=1,
        xlab="time (sec)", ylab="Encounter rate")
legend(30,0.1, names[c(1,4)], col=1:4, lty=1:4)
...
matplot(time, plot_data/rep, type="l", las=1,
        xlab="time (sec)", ylab="Encounter rate")
legend(20,0.15, names, col=1:4, lty=1:4)
...
d <- read.table("clipboard",header=T)
name <- d[,1:4]
names <- paste(name[,1],name[,2],name[,3],name[,4], sep=" and ")
time <- seq(0.2, 180, 0.2)
rep <- 1000
plot_data <- t(d[,5:length(d[1,])])
par(pin=c(5,4)*0.6, mfrow=c(2,1))
matplot(time, plot_data/rep, type="l", las=1,
        xlab="time (sec)", ylab="Encounter rate")
legend(60,0.15, names, col=1:4, lty=1:4)
