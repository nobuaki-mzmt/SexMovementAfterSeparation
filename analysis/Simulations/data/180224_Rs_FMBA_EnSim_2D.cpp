...
double rho[4] = { 0.7688358, 0.8634530, 0.7667347, 0.8473646 };
double speed[4] = { 5.370339, 14.77982, 15.033024, 14.70557 };
...
int initial(int id, int pattern) {
	...
	switch (pattern) {
	case 1:
		if (Rn <= 0.5) { Pnokori[id] = rbeki(1.577106); Wnokori[id] = 0; }
		else { Pnokori[id] = 0; Wnokori[id] = rbeki(2.674938); }
		break;
	case 2:
	case 3:
	case 4:
