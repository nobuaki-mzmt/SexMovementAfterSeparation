...
double rho[4] = { 0.7576250, 0.8659342, 0.7939391, 0.8467515 };
double speed[4] = { 5.622711, 12.52358, 11.570073, 11.70606 };
...
double Rn;
// initialization (1:f-before, 2:f-after, 3:m-before, 4:m-after)
